...
class CoursesModel extends Model {
	...
	function page_courses($page_what,$page_size,$where)
	{
		...
		$sql = "SELECT course.*,teacher.name,teacher.job,college.*,(select count(*) from chapter where chapter.cid=course.cid) as num FROM course  INNER JOIN teacher ON course.teacher_id = teacher.id INNER JOIN college on course.c_id = college.c_id";
		if(!empty($where))
		{
