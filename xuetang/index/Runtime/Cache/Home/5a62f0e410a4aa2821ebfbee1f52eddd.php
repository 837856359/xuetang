...
<footer>
    ...
    <div class="copyright">
        ...
        <div class="edx_logo cf fr">
            <a href="http://openedx.org/" target="_blank"><img src="/xuetang/Public/login_js/edx_logo.262fca70a49b.png"></a>
        </div>
    </div>
</footer>
    <script charset="utf-8" src="/xuetang/Public/login_js/v.js"></script><script src="/xuetang/Public/login_js/hm.js" async="" defer=""></script><script id="requirejs" src="/xuetang/Public/login_js/require.2d213b58c463.js"></script>
    <script src="/xuetang/Public/login_js/appCommon.1c7c3f1b8788.js"></script>
    <script src="/xuetang/Public/login_js/xuetanganalyse.18e1a992eb60.js"></script>
	 <script src="/xuetang/Public/login_js/homepage.2ea69a90ea53.js"></script> 

    


<div class="g_modal login_modal g_modal_scroll" id="g_modal" style="z-index: 151; height: 624px;"><div class="g_modal_cell" style="min-height: 686px;"><div class="g_modal_wrap" style="min-height: 686px;"><div id="login_modal" class="ng-scope">
	<div ng-controller="login" class="ng-scope">
		<div class="g_modal_header">
			<!-- ngIf: isDaytime -->
			<!-- ngIf: !isDaytime --><img ng-if="!isDaytime" src="/xuetang/Public/login_js/login_header_night.gif" class="ng-scope"><!-- end ngIf: !isDaytime -->
		</div>
...
<!--  登陆开始   -->
			...
			<!-- 管样式-->
				...
				<!--用户名-->
			<div >
                            <input name="dluname" id="dluname" style="text-align: left"  type="text" placeholder="登录邮箱/用户名/手机号" onblur="text_name()">
						  <span class="error ng-scope" name="spname" id="spname"></span>
						<div class="focus_icon form_message success hide"></div>
					</div>
					<!--用户名-->
					<div class="field">
						<input name="pwd" style="text-align: left" id="pwd" type="password" placeholder="密码" onblur="text_pwd()" >
				
						<span class="error ng-scope" name="sppwd" id="sppwd"></span>
						
						<div class="focus_icon form_message success hide"></div>
					</div>
					<!-- ngIf: loginText.isShowCode -->
					<div class="inline field cf forget_pwd">
						<div class="ui checkbox checked">
							<input name="remember" type="checkbox" ui-checkbox="" value="true" checked="checked" class="ng-isolate-scope">
							<label>记住我</label>
						</div>
						<a class="fr" href="http://www.123123.com/forget_password" target="_blank">忘记密码</a>
					</div>
				</div>
				<div class="btn">
					<div class="error_message ng-hide" ng-show="loginText.errorMessage">
						<p class="ng-binding"></p>
					</div>
					<button class="ui purple button" ng-class="{loading: loginText.submitLoading}" type="button" onclick="dl()">立即登录</button>
	...
	<!--登录结束-->
		...
		<div class="g_modal_footer">
			<p class="pt50">使用第三方账号 或 使用邮箱<a ng-click="goToLogin()" href="/xuetang/index.php/Home/Index/register" title="登录"> 注册 ›</a></p>
...
<a href="javascript:void(0)"><div class="g_modal_closeBtn" title="关闭" onclick="history.go(-1)"></div></a>
		...
		function text_name(){
     	dluname=$("#dluname").val();//alert(dluname);
     	//alert(dluname);
        if(dluname==""){
		$("#spname").html("<font color='red'>×用户名不能为空</font>");
		return false;
		}else{
		$("#spname").html("<font color='green'>用户名已输入</font>");
		return false;
		}
    }
	function text_pwd(){
	...
	if(pwd==""){
		...
		$("#sppwd").html("<font color='green'>格式正确</font>");
		return false;
		}
     ...
     dluname=$("#dluname").val();
	  pwd=$("#pwd").val();//alert(dluname);alert(pwd); return false;
      if(dluname==""){
		$("#spname").html("<font color='red'>用户名不能为空</font>");
		return false;
		}
      ...
      $.ajax({
	     url:"/xuetang/index.php/Home/Index/logindo",             
         data:{"dluname":dluname,"pwd":pwd},
		 type:"post",
		 success:function(e){
				/*返回值
				0.没有该用户,
				...
				*/
			 if(e=='00'){
			  $("#spname").html("<font color='red'>用户名为空哦.亲(●—●)</font>");return false;
			 } 
			 if(e=='11'){
			  $("#sppwd").html("<font color='red'>密码为空</font>");return false;
			 }
		     if(e=='0'){
			  $("#spname").html("<font color='red'>用户名不存在哦.亲(●—●)</font>");return false;
			 }
			 if(e=='1'){
              $("#sppwd").html("<font color='red'>密码错误</font>");return false;
			 }
			 if(e=='5'){
			  $("#spname").html("<font color='red'>邮箱是不是写错了?亲(●—●)?</font>");return false;
			 }
			 if(e=='6'){
              $("#sppwd").html("<font color='red'>×你是不是吧密码忘了!</font>");return false;
			 }
			    if(e=='3'){
			  $("#spname").html("<font color='red'>手机号码错误!</font>");return false;
			 }
			 if(e=='4'){
              $("#sppwd").html("<font color='red'>你是不是吧密码忘了?</font>");return false;
			 }
