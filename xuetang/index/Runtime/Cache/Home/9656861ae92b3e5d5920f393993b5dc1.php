...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <script type="text/javascript" src="/xuetang/Public/js/jquery_005.js"></script>
...
<link href="/xuetang/Public/css/googlefonts.css" rel="stylesheet" type="text/css">
 ...
 <body class="ltr discussion lang_zh-cn">
     <div style="visibility: hidden; overflow: hidden; position: absolute; top: 0px; height: 1px; width: auto; padding: 0px; border: 0px none; margin: 0px; text-align: left; text-indent: 0px; text-transform: none; line-height: normal; letter-spacing: normal; word-spacing: normal;"><div id="MathJax_Hidden"></div></div>
...
function filterrank(key){
	$.ajax({
        ...
        <div class="discussion-column">
         <!-- <article class="new-post-article" style="">-->
    <form class="forum-new-post-form"  method="post" action="/xuetang/index.php/Home/Discuss/add_card_pro">
    ...
    <div class="post-field">
        <div class="field-label">
            <span class="field-label-text">
              ...
              <!--  <input name="type" class="post-type-input" id="type" value="1" type="radio">
                <label for="form-25-post-type-question" class="post-type-label">
                    <i class="icon fa fa-question"></i>
                    问题
                </label>
                <input name="type" class="post-type-input" id="type" value="2" checked="checked" type="radio">
...
<div class="post-field">
    <div class="field-label">
        <span class="field-label-text">主题范围:</span><div class="field-input post-topic">
            <a href="#" class="post-topic-button" id="sel">
                <span class="sr">讨论主题；当前选中的是:</span>
                <span class="js-selected-topic" id="checked">General</span>
                <span class="drop-arrow" aria-hidden="true">▾</span>
            </a>

            <div style="display:none" class="topic-menu-wrapper" id="op">
             <label class="topic-filter-label">
                    <span class="sr">筛选主题</span>
                    <input class="topic-filter-input" placeholder="筛选主题" type="text" id="key" onkeyup="search()">
                </label>

                <ul class="topic-menu" role="menu">
<?php if(is_array($arr)): foreach($arr as $key=>$row): ?><li role="menuitem" class="topic-menu-item">
        <span class="topic-title"><?php echo ($row["ch_name"]); ?></span>
        <ul role="menu" class="topic-submenu">
		<?php foreach($row['know'] as $key=>$val){ ?>


    <li role="menuitem" class="topic-menu-item" >
        <a href="#" class="topic-title" value="<?php echo $key; ?>" onclick="check('<?php echo $val ?>','<?php echo $key ?>')"><?php echo $val; ?></a>
    </li>
...
<script type="text/javascript">
	...
	function search(){
		var key=$("#key").val();
		$.ajax({
			url:'/xuetang/index.php/Home/Discuss/search',
			data:{'key':key},
			type:'get',
			success:function(e){
				alert(e);
        ...
        <div class="post-field">
            <label class="field-label">
                ...
                <input class="field-input js-post-title" id="title" name="title" placeholder="标题" type="text">
            </label><span class="field-help">
                添加一个清晰明了的标题来激励大家参与.
            </span>
        </div>
        <div class="post-field js-post-body editor" name="body" data-placeholder="输入你的问题或评论"><div class="wmd-panel">
		
		<label for="wmd-input-js-post-body-undefined" class="sr">帖子内容</label>
		
		<textarea placeholder="输入你的问题或评论" class="wmd-input" id="desc"></textarea>
        ...
        <div class="post-options">
            <label class="post-option is-enabled">
                <input id="follow" class="post-option-input js-follow" checked="checked" value="1" type="checkbox">
        ...
        <div>
            <input class="submit" value="添加帖子" type="button" onclick="checkadd()">
...
function checkadd(){
 	...
 	var type=$("#form-25-post-type-question").val();
	var theme=$("#theme").val();
	var title=$("#title").val();
	var desc=$("#desc").val();
	...
	//alert(theme);
	$.ajax({
		url:"/xuetang/index.php/Home/Discuss/addCardPro",
		data:{"type":type,"theme":theme,"title":title,"desc":desc,"is_follow":follow,'kid':kid},
		type:'post',
		success:function(e){
			if(e==1){
				alert("发帖成功");
				location.href="/xuetang/index.php/Home/Discuss/addCard";
			}else if(e==0){
				alert("发帖失败");
				location.href="/xuetang/index.php/Home/Discuss/addCard";
			}
          ...
          <div style="display: none;" class="forum-content">
  <div class="discussion-article blank-slate">
    <section class="home-header">
      <span class="label">讨论空间:</span>
        <h1 class="home-title"><?php echo ($ch_name); ?></h1>
    </section>
  ...
  <script src="http://tjs.sjs.sinajs.cn/open/api/js/wb.js" type="text/javascript" charset="utf-8"></script>
        ...
        <div id="tu-footer">
            <div class="tu-container">
                <div class="pull-left">
                    <img src="/xuetang/Public/img/edx_logo.png" alt="Home Page" height="60">
                </div>
