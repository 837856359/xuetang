...
<!-- saved from url=(0139)http://www.xuetangx.com/courses/TsinghuaX/00740043_2X/2015_T1/courseware/8d1fd477f469492ba2c1297e6ace6f5d/1d1a38e6e4de487e8010376dd9265988/ -->
...
.MathJax img, .MathJax nobr, .MathJax a {border: 0; padding: 0; margin: 0; max-width: 5000em; max-height: 5000em; vertical-align: 0; line-height: normal; text-decoration: none}
...
<!-- end dummy segment.io -->
  ...
  <div class="window-wrap" dir="ltr" style="overflow:hidden;position:relative;">
    <a class="nav-skip" href="http://www.xuetangx.com/courses/TsinghuaX/00740043_2X/2015_T1/courseware/8d1fd477f469492ba2c1297e6ace6f5d/1d1a38e6e4de487e8010376dd9265988/#seq_content">跳过本内容页</a>
...
<![endif]-->
  ...
  <img src="/xuetang/Public/images/tsinghua-T-logo2.ab6041c8bde0.png" height="60" alt="Home Page" id="tsinghua-logo">
  <style>
  .home>header{
    background-image: url("/xuetang/Public/images/tsinghua-pano.jpg");
        ...
        <h2>
            <span class="provider">TsinghuaX:</span>
...
<div id="main" class="sequence" data-id="i4x://TsinghuaX/00740043_2X/sequential/1d1a38e6e4de487e8010376dd9265988" data-position="1" data-ajax-url="/courses/TsinghuaX/00740043_2X/2015_T1/xblock/i4x:;_;_TsinghuaX;_00740043_2X;_sequential;_1d1a38e6e4de487e8010376dd9265988/handler/xmodule_handler">
  <nav class="sequence-nav">
    <ul class="sequence-nav-buttons">
      <li class="prev"><a role="button" href="http://www.xuetangx.com/courses/TsinghuaX/00740043_2X/2015_T1/courseware/8d1fd477f469492ba2c1297e6ace6f5d/1d1a38e6e4de487e8010376dd9265988/#" class="disabled" aria-hidden="true">上一个</a></li>
    </ul>

    <div class="sequence-list-wrapper" >
      <ol role="tablist" aria-label="章节导航" id="sequence-list">
        <li>
        <a class="seq_video progress-0 active" data-element="1" title="<?php echo ($title[0]['know']); ?>" data-page-title="<?php echo ($title[0]['know']); ?>" >
            <p aria-hidden="false"><?php echo ($title[0]['know']); ?></p>
          </a>
        </li>
        <li>
        <a class="seq_problem inactive progress-none "  data-element="2" href="#" title="<?php echo ($title[0]['know']); ?>课后习题" data-page-title="<?php echo ($title[0]['know']); ?>课后习题" aria-controls="seq_contents_1" id="tab_1" tabindex="0" role="tab" onclick="question()">
            <p aria-hidden="false"><?php echo ($title[0]['know']); ?>课后习题</p>
          </a>
        </li>
        <li>
        <a class="seq_other inactive progress-0" data-id="i4x://TsinghuaX/00740043_2X/vertical/815928a16e1c4b6faf696b5ed416bec9" data-element="3" href="javascript:void(0);" title="<?php echo ($title[0]['know']); ?>讨论区" data-page-title="<?php echo ($title[0]['know']); ?>讨论区" aria-controls="seq_contents_2" id="tab_2" tabindex="0" role="tab">
            <p aria-hidden="false"><?php echo ($title[0]['know']); ?>讨论区</p>
          </a>
        </li>
      </ol>
    ...
    <ul class="sequence-nav-buttons">
      <li class="next"><a role="button" href="http://www.xuetangx.com/courses/TsinghuaX/00740043_2X/2015_T1/courseware/8d1fd477f469492ba2c1297e6ace6f5d/1d1a38e6e4de487e8010376dd9265988/#" aria-hidden="false">下一个</a></li>
    </ul>
  </nav>
	

	
<form method="post" action="/xuetang/index.php/Home/Courseware/answer">
	


	<?php echo $ques[0]['qid'];?>、<?php echo ($ques[0]['question']); ?><br>
  <?php foreach($new_cart as $aa){?>
	
	<input type="radio" name="xuan"  value="<?php echo $aa;?>"><?php echo $aa;?><br>
	
  <?php }?>
  <input type="hidden" name="kid"  value="<?php echo $ques[0]['kid'];?>">
   <input type="hidden" name="qid"  value="<?php echo $ques[0]['qid'];?>">
  <br>
...
<div id="accessibile-confirm-modal" class="modal" aria-hidden="true">
  ...
  <a href="http://www.xuetangx.com/courses/TsinghuaX/00740043_2X/2015_T1/courseware/8d1fd477f469492ba2c1297e6ace6f5d/1d1a38e6e4de487e8010376dd9265988/#accessibile-confirm-modal" rel="leanModal" id="confirm_open_button" style="display:none">打开</a>
</div>
...
var accessible_confirm = function(message, callback) {
    ...
    $("#accessibile-confirm-modal .message-title").html(message);
            ...
            <footer>
                <div class="colophon" style="width:100%;">
                    <nav class="nav-colophon">
                        ...
                        <div id="weibo-follow-btn"><iframe id="sina-btn" frameborder="0" scrolling="no" src="/xuetang/Public/html/followbutton.htm"></iframe></div>
                    </nav>
                </div>
            </footer>
        ...
        <div id="tu-footer">
            <div class="tu-container">
                <div class="pull-left">
                    <img src="/xuetang/Public/js/logo-tsinghua-studio-white-footer.bc45756b9d4f.png" height="60" alt="Home Page">
                </div>
...
<section class="pagination"/>
  ...
  <script type="text/javascript">
	...
	function tiao(id){
		...
		var kid=id;
		//alert(kid);
		location.href="/xuetang/index.php/Home/Courseware/detail?id="+kid;
		
	}
  </script>


  <div style="display:none;"><script type="text/javascript" src="/xuetang/Public/js/analyse.63acb5fb16e9.js"></script><script src="/xuetang/Public/js/h.js" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=32d56203d9a79a16a032531755dad60e" target="_blank"><img border="0" src="/xuetang/Public/js/21.gif" width="20" height="20"></a></div>


<div class="tooltip" style="display: none; opacity: 0;"></div><div id="lean_overlay"></div><div id="reader-feedback" class="sr" style="display:none" aria-hidden="false" aria-atomic="true" aria-live="assertive"></div><div id="MathJax_Font_Test" style="position: absolute; visibility: hidden; top: 0px; left: 0px; width: auto; padding: 0px; border: 0px; margin: 0px; white-space: nowrap; text-align: left; text-indent: 0px; text-transform: none; line-height: normal; letter-spacing: normal; word-spacing: normal; font-size: 40px; font-weight: normal; font-style: normal; font-family: MathJax_Size1, sans-serif;"></div></body></html>