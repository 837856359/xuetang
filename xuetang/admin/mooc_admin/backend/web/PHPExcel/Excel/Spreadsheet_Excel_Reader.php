<?php
namespace backend\web\PHPExcel\Excel;
...
//require_once 'PHPExcel/Excel/OLERead.php';
//require_once 'PHPExcel/Excel/oleread.inc';
//require_once 'Classes/PHPExcel/Shared/OLERead.php';
//require 'PHPExcel/Excel/OLERead.php';
