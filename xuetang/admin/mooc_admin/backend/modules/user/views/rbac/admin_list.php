...
<div class="page-header">
    ...
    <a href="index.php?r=user/rbac/admin_add"><button class="btn btn-grey" style="margin-left:12px;">管理员添加</button></a>
			...
			<table id="sample-table-1" class="table table-striped table-bordered table-hover">
				...
				<?php foreach($arr as $v){?>
						...
						<td align="center">
							...
							<!-- <form method='post' action='index.php?r=/user/rbac/update'><input type='hidden' value="<?php echo $v['id']?>" name='id'><input type='submit' value='修改' class="btn btn-xs btn-danger margin0"></form>
                                -->
