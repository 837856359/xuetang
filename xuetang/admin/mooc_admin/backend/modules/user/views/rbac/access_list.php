...
<!------------------------------主要内容---------------------------------------->
    ...
    <ul class="breadcrumb">
        ...
        <li class="active" style="float:left; margin-top:10px;">权限列表</li>
    </ul>
...
<div class="page-header">
    ...
    <a href="index.php?r=user/rbac/admin_add"><button class="btn btn-grey" style="margin-left:12px;">权限添加</button></a>
				...
				<thead>                                   
					<tr>
						<td align="center">序号</td>
						 <td class="hidden-480" align="center">权限名称</td>
...
function Recycle(id){
	//alert(id);
     ...
     $.ajax({
	   url:"index.php?r=user/user/del_node",
	   data:{"id":id},
	   type:"post",
	   success:function(e){
              //alert(e);
		    if(e==1){
			   alert('删除成功！');
			   location.href='index.php?r=user/user/access_list';
			}else{
				alert("删除失败");
			}
		}
