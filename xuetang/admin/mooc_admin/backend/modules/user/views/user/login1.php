			   ...
			   <tr>
			    ...
			    <tr>
				 <td align="right" width="200">
					 <input style="background:url(Public/img/exambtn.gif) no-repeat;width:80px;height:34px;border:0;margin-right:-8px;" type="button" name="yt0" value="" id="but"/> 
				 </td>
				 <td align="left" width="200">
				     <input type="reset" value='' style="background:url(Public/img/button2.gif) no-repeat;width:80px;height:34px;border:0;cursor:pointer;margin-left:25px;">
