...
<form class="dropzone dz-clickable" method="post" action="index.php?r=user/course/add_course" enctype="multipart/form-data">
...
<div class="col-xs-2" style="margin-left:100px;">
                <textarea name="intro" rows="2" cols="80"></textarea>
...
<span>
<font style="margin-left:-59%;color:#000;font-family:黑体; font-size:18px; font-weight:normal; margin-right:650px;" size="5">图片:</font>
<div class="col-xs-2" style="margin-left:100px;">
<div id="iamges_queue"></div>
<input id="images_upload" name="images_upload" type="file" multiple="true">
</div>
...
<span>
<font style="color:#000;margin-left:-71%; font-family:黑体;font-size:18px;font-weight:normal;size='5'">视频:</font>
<div class="col-xs-2" style=" width:450px; margin-left:100px;">
