...
<form class="dropzone dz-clickable" method="post" action="index.php?r=user/course/add_chapter" enctype="multipart/form-data">
...
<div class="col-xs-2" style="margin-left:100px;">
               <input type="text" name="ch_name" class="form-control">
...
<div class="col-xs-2" style="margin-left:100px;">
               <input type="radio" name="num" value="1" class="form-radio"><font size="3">是</font>              <input type="radio" name="num" value="0" class="form-radio"><font size="3">否</font>
                </div>
