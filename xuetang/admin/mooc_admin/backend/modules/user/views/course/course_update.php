...
<form class="dropzone dz-clickable" method="post" action="index.php?r=user/course/course_up_save" enctype="multipart/form-data">
...
<div class="col-xs-2" style="margin-left:100px;">
                ...
                <select name="c_id" id="one" class="form-control" onchange="ck_two()">
							...
							<?php foreach ($one as $one):?>
								...
								<option value="<?php echo $one['c_id']?>" <?php echo $one['c_id']==$data[0]['c_id']? 'selected':''?>><?php echo $one['c_name']?>
...
<div class="col-xs-2" style="margin-left:100px;">
                ...
                <select name="mid" id="two"  class="form-control"  onchange="ck_three()">
								...
								<?php foreach ($major as $major):?>

								<option value="<?php echo $major['m_id']?>" <?php echo $major['m_id']==$data[0]['mid']? 'selected':''?>><?php echo $major['m_name']?>
...
<div class="col-xs-2" style="margin-left:100px;">
                ...
                <select  class="form-control" name="sid">
					...
					<?php foreach ($stage as $stage): ?>
						...
						<option value="<?php echo $stage['sid']?>" <?php echo $stage['sid']==$data[0]['sid']?'selected':'';?>><?php echo $stage['s_name'];?>
...
<div class="col-xs-2" style="margin-left:100px;">
               ...
               <input type="text" value="<?php echo $data[0]['cname']?>" name="cname" class="form-control">
...
<font style="margin-left:-59%;color:#000;font-family:黑体; font-size:18px; font-weight:normal; margin-right:650px;" size="5">排序:</font>



<div class="col-xs-2" style="margin-left:100px;">

               <input type="text" value="<?php echo $data[0]['sort']?>" name="sort" class="form-control" style="width:50px;">
...
<font style="margin-left:-59%;color:#000;font-family:黑体; font-size:18px; font-weight:normal; margin-right:650px;" size="5">最热:</font>



<div class="col-xs-2" style="margin-left:100px;">

               <select  class="form-control" name="is_hot" style="width:50px;">

                   <option <?php if($data[0]['is_hot']==0){ echo "selected";}?> value="0" >否</option>

                   <option <?php if($data[0]['is_hot']==1){ echo "selected";}?> value="1" >是</option>
...
<font style="margin-left:-59%;color:#000;font-family:黑体; font-size:18px; font-weight:normal; margin-right:650px;" size="5">最新:</font>



<div class="col-xs-2" style="margin-left:100px;">

               <select  class="form-control" name="is_new" style="width:50px;">

                   <option <?php if($data[0]['is_new']==0){ echo "selected";}?> value="0" >否</option>

                   <option <?php if($data[0]['is_new']==1){ echo "selected";}?> value="1" >是</option>
...
<font style="margin-left:-59%;color:#000;font-family:黑体; font-size:18px; font-weight:normal; margin-right:650px;" size="5">推荐:</font>



<div class="col-xs-2" style="margin-left:100px;">

               <select  class="form-control" name="is_recommend" style="width:50px;">

                   <option value="0" <?php if($data[0]['is_recommend']==0){ echo "selected";}?> >否</option>

                   <option value="1" <?php if($data[0]['is_recommend']==1){ echo "selected";}?> >是</option>
...
<div class="col-xs-2" style="margin-left:100px;">
                ...
                <textarea name="intro" rows="2" cols="80"><?php echo $data[0]['intro']?></textarea>
...
<div class="col-xs-2" style="margin-left:100px;">
                ...
                <select  class="form-control" name="teacher">
					...
					<?php foreach ($teacher as $teacher): ?>
						...
						<option <?php if($data[0]['teacher_id']==$teacher['id']){ echo "selected";}?> value="<?php echo $teacher['id']?>"><?php echo $teacher['name'];?>
