...
//                if (strRtn != undefined  && strRtn !='') this.doEquation(chunk, postProcessing, strRtn);
		...
		+"<div class='LJN_panel'>"
		    ...
		    +"<div class = 'preview_container'><div class='preview_label'>预览</div>"
		    +"<div id='MathOutput' class='LJN_preview'></div>"
		+"</div>"
	    +"</div><button id='btn_submit' class='btn_submit'>确认</button><button id='btn_cancel' class='btn_cancel'>取消</button></div>");
		for (var i in list) {
